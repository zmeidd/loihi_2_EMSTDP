 ...
 old_weights = None,
    ...
    while ep < 1:
            if detect ==0:
                ...
                task_id = False
            snn_predict.lr = 0.0002 -ep*0.00001
            ...
            for i in trange(int (d_15_train_label.shape[0] / batch_size )):
                if len(mem)!=0:
                    if i%2 ==0:
                            snn_predict.lr = 0.00025 -ep*0.00001
            ...
            if (acn < 0.995 and detect< detect_size):
                ep = 0
            else:
                ep = ep +1
            detect = detect + 1
...
def test_snn(snn_network,d_30_test, d_30_test_label, dense_size = 784, conv= False, total_test = 400, T =100 , test_batch =10):
